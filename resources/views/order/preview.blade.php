    ...
    <div class="" style="border: 1px solid #000;padding: 18px;">
            ...
            <tbody>
                <tr>
                    <td class="tdCompanyName w-33"style="text-align: left; line-height: 16px;">
                        <div class="lblCompanyAdd">
                            <i
                                id="">{{ $data['branch'][0]['address_line_1'] }},{{ $data['branch'][0]['address_line_2'] }}</i>
                            <br><i id="">{{ $data['branch'][0]['name'] }},{{ $data['company']['name'] }}</i>
                            <br><i
                                id="">{{ $data['branch'][0]['area'] }}-{{ $data['branch'][0]['pincode'] }}</i>
                            <br>
                            <img src="https://erp.whitelion.in/axone_work/whatsapp.svg" style="width: 11px;"
                                alt="">&nbsp;&nbsp;<i
                                id="">{{ $data['branch'][0]['phone_number'] }}</i>
                            <br><img src="https://erp.whitelion.in/axone_work/email.svg" style="width: 11px;"
                                alt="">&nbsp;<i id="">{{ $data['branch'][0]['email'] }}</i>
                    ...
                    <td class="tdInvoiceType w-33" style="text-align: right;line-height: 16px;">
                        <div class="lblCompanyAdd">
                            <i
                                id="">{{ $data['branch'][0]['arabic_address_line_1'] }},{{ $data['branch'][0]['arabic_address_line_2'] }}</i>
                            <br><i id="">{{ $data['branch'][0]['name'] }},{{ $data['company']['name'] }}</i>
                            <br><i
                                id="">{{ $data['branch'][0]['arabic_area'] }}-{{ $data['branch'][0]['pincode'] }}</i>
                            <br><i id="">{{ $data['branch'][0]['phone_number'] }}</i>&nbsp;<img
                                src="https://erp.whitelion.in/axone_work/whatsapp.svg" style="width: 11px;"
                                alt="">
                            <br><i id="branch_email_arb[0]ic">{{ $data['branch'][0]['email'] }}</i>&nbsp;<img
                ...
                @if ($data['company']['id'] == 2)
                    <tr style="line-height: 10mm;">
                        ...
                        <td class="w-33 fontb" style="text-align: center;vertical-align: middle;font-size: 16px;">TRN: &nbsp; <span >100282361300007
                            </td>
                    ...
                    <tr>
                        ...
                        <td class="w-33" style="text-align: center;vertical-align: middle;font-size: 15px;"> date
                            :&nbsp;
                            <i id=""style="border-bottom: 1px dashed #b99052;">{{ date('d/ M/ Y') }}</i>
                        </td>
                    </tr>
                @else
                    <tr style="line-height: 10mm;">
                        <td class="w-33 fontb" style="font-size: 18px;"></td>
        ...
        <table>
            <tr style="line-height: 20px;">
                ...
                <td class="w-40">&nbsp;{{ $data['client_name'] }}</td>
        ...
        <table style="margin-top: 10px;">
            <tr style="line-height: 20px;">
                ...
                <td class="w-30">&nbsp;{{ $data['client_phone_number'] }}</td>
                <td class="w-5 vbottom">E-mail :</td>
                <td class="w-30">&nbsp;{{ $data['client_email_address'] }}</td>
            </tr>
        </table>
        ...
        <table class="border ">
            ...
            @foreach ($data['order']['items'] as $item)
                <tr class="border-b" style="text-align: right">
                    ...
                    <td class="border-l  height padd alignc">&nbsp;{{ $item['item_design_no'] }}</td>
                    <td class="border-l  height padd alignc">&nbsp;{{ $item['item_name'] }}</td>
                    <td class="border-l  height padd alignc">&nbsp;{{ number_format($item['item_gold_ct'], 2) }}</td>
                    <td class="border-l  height border-t padd alignc">&nbsp;{{ explode('.',$item['grm'])[0] }}</td>
                    <td class="border-l  border-t height padd alignc">&nbsp;{{ explode('.',$item['grm'])[1] }}</td>
                    <td class="border-l  height padd alignc">&nbsp;{{ number_format($item['item_diamond_ct'], 2) }}</td>
                    <td class="border-l  border-t height padd">&nbsp;{{ number_format($item['item_vat'], 2) }}</td>
                    <td class="border-l  border-t height padd alignc">&nbsp;{{ $item['qty'] }}</td>
                    <td class="border-l  height padd">&nbsp;{{ number_format($item['item_vat_gross_amt'], 2) }}</td>
                    <td class="border-l  border-r height padd">&nbsp;</td>
                </tr>
            @endforeach
            @for ($i = count($data['order']['items']); $i < 15; $i++)
                <tr class="border-b" style="text-align: right">
            ...
            <tr class="border-b">
                ...
                <td class="border-l height padd" style="text-align: right">
                    {{ number_format($data['order']['total_item_vat_gross_amt'], 2) }}</td>
                <td class="border-l border-r height padd">&nbsp;</td>
            </tr>
            <tr class="border-b">
            ...
            <tr class="border-b">
                ...
                <td class="border-l height padd" style="text-align: right">
                    &nbsp;{{ number_format($data['order']['total_item_bill_amt'], 2) }}
                </td>
                <td class="border-l border-r height padd" style="text-align: right">&nbsp;</td>
            </tr>
            <tr class="border-b">
        ...
        <table style="font-size: 12px;">
            ...
            <tr style="line-height: 20px;">
                <td class="alignc" colspan="2">Happy to Visit Again, Or Refer your Friend to Avail a Free Pick Up
                    or Drop to Our Other Branch[0]es.</td>
            </tr>
            <tr style="line-height: 20px;">
                <td class="alignr" id="w-60"> • Souk Madinat Jumeirah &nbsp;&nbsp;&nbsp; • Gold & Diamond Park
                </td>
                <td class="alignl w-20" style="text-align: right"> <img src="{{ $data['user']['sig_img'] }}"
