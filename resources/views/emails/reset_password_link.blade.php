                                ...
                                <tr>
                                    <td valign="top" class="bodyContent" mc:edit="body_content">
                                        ...
                                        <p>Otherwise, please click this link to change your password:
                                            <a
                                                href="{{ route('reset.password', $params['reset_password_token']) }}">{{ route('reset.password', $params['reset_password_token']) }}</a>
                    ...
                    <tr>
                        <td align="center" valign="top" id="bodyCellFooter" class="unSubContent">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                id="templateContainerFooter">
                                <tr>
                                    <td valign="top" width="100%" mc:edit="footer_unsubscribe">
                                        <h6 style="text-align:center;margin-top: 9px;">Whitelion Systems Private Limited
                                        </h6>
        ...
        <tr>
            <td height="1" class="hide" style="min-width:600px; font-size:0px;line-height:0px;">
                <img height="1" width="600"
                    src="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/blank.jpg"
                    style="min-width: 600px; width: 600px; max-height: 1px; min-height: 1px; text-decoration: none; border: none; -ms-interpolation-mode: bicubic;" />
            </td>
        </tr>
    </table>
</body>
